...
class GraphQLMessages(_message.Message):
    ...
    send: GraphQLQuerySend
    recv: GraphQLPayloadString
    def __init__(self, send: _Optional[_Union[GraphQLQuerySend, _Mapping]] = ..., recv: _Optional[_Union[GraphQLPayloadString, _Mapping]] = ...) -> None: ...

class GraphQLQuerySend(_message.Message):
    __slots__ = ("num", "payload", "code", "b")
    NUM_FIELD_NUMBER: _ClassVar[int]
    PAYLOAD_FIELD_NUMBER: _ClassVar[int]
    CODE_FIELD_NUMBER: _ClassVar[int]
    B_FIELD_NUMBER: _ClassVar[int]
    num: int
    payload: GraphQLPayloadString
    code: bytes
    b: GraphQLStringValue
    def __init__(self, num: _Optional[int] = ..., payload: _Optional[_Union[GraphQLPayloadString, _Mapping]] = ..., code: _Optional[bytes] = ..., b: _Optional[_Union[GraphQLStringValue, _Mapping]] = ...) -> None: ...

class GraphQLPayloadString(_message.Message):
    __slots__ = ("value", "text")
    VALUE_FIELD_NUMBER: _ClassVar[int]
    TEXT_FIELD_NUMBER: _ClassVar[int]
    value: int
    text: str
    def __init__(self, value: _Optional[int] = ..., text: _Optional[str] = ...) -> None: ...
